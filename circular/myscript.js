...
function backw0(){
   ...
   tl.to($hand2,0,{ directionalRotation: "+=" + speed2 +  "_cw", ease: Linear.easeNone},"-=0")
   dec20zero()
   //dec202zero()
...
function createSpace(){
  ...
  tl.to($hand2,0,{ directionalRotation: "-=" + dspeed3 +  "_ccw" })
...
function dec20zero() {
  tl.to(game, 0, {score:"-=1", roundProps:"score", onUpdate:updateHandler, ease:Linear.easeNone},"-=0");
}
...
function updateHandler() {
  ...
  spd2c = ospeed2 * game.score  

  var term1 = space + spd1c + spd2c;
  var term2 = term1 % distance0
